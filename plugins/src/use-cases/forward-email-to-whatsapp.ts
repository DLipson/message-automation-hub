import type {
  InboundEmail, MediaAttachment, AppLogger,
  EmailInbox, EmailStatusMarker, EmailSender,
  SentMessage, WhatsAppSender,
  EmailAutomationBatch, EmailAutomationHandler,
} from "@message-automation/core/api/index.js";
import { formatError, parseSubjectCommand, isImageAttachment } from "../utils.js";
